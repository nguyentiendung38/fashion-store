...
<div class="container-fluid max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-3xl font-bold text-gray-800">Chỉnh Sửa Ảnh Instagram</h1>
        </div>
        <p class="text-gray-600 ml-9">Cập nhật thông tin ảnh Instagram</p>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-lg shadow-md p-8">
        <form action="{{ route('admin.instagram.update', $instagramBanner) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <select name="position"
                    ...
                    <option value="1" {{ old('position', $instagramBanner->position) == 1 ? 'selected' : '' }}>Vị trí 1</option>
                    <option value="2" {{ old('position', $instagramBanner->position) == 2 ? 'selected' : '' }}>Vị trí 2</option>
                    <option value="3" {{ old('position', $instagramBanner->position) == 3 ? 'selected' : '' }}>Vị trí 3</option>
                    <option value="4" {{ old('position', $instagramBanner->position) == 4 ? 'selected' : '' }}>Vị trí 4</option>
                    <option value="5" {{ old('position', $instagramBanner->position) == 5 ? 'selected' : '' }}>Vị trí 5</option>
                    <option value="6" {{ old('position', $instagramBanner->position) == 6 ? 'selected' : '' }}>Vị trí 6</option>
                </select>
                @error('position')
            ...
            <div class="mb-6">
                ...
                <div class="border border-gray-300 rounded-lg p-4 bg-gray-50">
                    <img src="{{ Storage::url($instagramBanner->image_path) }}"
            ...
            <div class="mb-6">
                <label class="block text-gray-700 font-semibold mb-2">
                    Thay Đổi Ảnh <span class="text-gray-500 text-sm">(Tùy chọn)</span>
                </label>
                ...
                <p class="text-gray-500 text-sm mt-2">
                    ...
                    Định dạng: JPG, PNG, WEBP. Kích thước đề xuất: 800x800px. Dung lượng tối đa: 5MB
                </p>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="url"
                        ...
                        value="{{ old('instagram_url', $instagramBanner->instagram_url) }}">
                </div>
                @error('instagram_url')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-6">
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox"
                        ...
                        {{ old('is_active', $instagramBanner->is_active) ? 'checked' : '' }}>
                    <span class="ml-2 text-gray-700 font-semibold">Hiển thị ảnh</span>
                </label>
            </div>
            ...
            <div class="flex gap-3 pt-4 border-t border-gray-200">
                <button type="submit"
                    class="flex-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2">
