...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Quản lý Hot Trend</h2>
        <a href="{{ route('admin.hot-trends.create') }}"
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="p-4 whitespace-nowrap text-gray-700">{{ $hotTrend->id }}</td>

                        <td class="p-4 whitespace-nowrap">
                            <img src="{{ Storage::url($hotTrend->image) }}"
                                alt="{{ $hotTrend->name }}"
                        ...
                        {{-- Giảm giá --}}
                        <td class="p-4 whitespace-nowrap text-gray-700">
                            {{ $hotTrend->discount ? $hotTrend->discount . '%' : 'Không' }}
                        </td>
