...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form action="{{ route('admin.hot-trends.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <div class="bg-white rounded-xl shadow-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h4 class="text-xl font-semibold text-gray-800">Thêm Hot Trend Mới</h4>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="space-y-6">
                    {{-- Tên --}}
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Tên <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="discount" class="block text-sm font-medium text-gray-700 mb-2">
                            Giảm giá (%) <span class="text-gray-400 text-xs">(tùy chọn)</span>
                        </label>
                        <div class="flex">
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-end space-x-4 rounded-b-xl">
                <a href="{{ route('admin.hot-trends.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-lg transition duration-300">
                    Hủy bỏ
                </a>
