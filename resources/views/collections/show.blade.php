            ...
            <div class="max-w-6xl mx-auto">
                ...
                <nav aria-label="Breadcrumb">
                    <ol role="list" class="flex items-center space-x-2 text-sm">
                        <li><a href="#" class="font-medium text-gray-500 hover:text-gray-700">Trang chủ</a></li>
                        <li><svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true" class="h-5 w-4 text-gray-300">
                                <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
                            </svg></li>
                        <li><a href="#" class="font-medium text-gray-500 hover:text-gray-700">Váy Đầm</a></li>
                    </ol>
                </nav>
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                    ...
                    <div class="space-y-4">
                        ...
                        <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper main-swiper w-full rounded-lg overflow-hidden border border-gray-200">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{ Storage::url($collection->image) }}" alt="Váy Lụa Tay Phồng Cổ Vuông" class="gallery-image h-full w-full object-cover object-center cursor-pointer aspect-[3/4]">
                                </div>
                                {{-- Slides cho các ảnh phụ --}}
                                @foreach($collection->images as $image)
                                <div class="swiper-slide">
                                    <img src="{{ Storage::url($image->image) }}" alt="Ảnh chi tiết sản phẩm" class="gallery-image h-full w-full object-cover object-center cursor-pointer aspect-[3/4]">
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div thumbsSlider="" class="swiper thumb-swiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{ Storage::url($collection->image) }}" class="h-24 w-full object-cover rounded-md border border-gray-200 cursor-pointer">
                                </div>
                                {{-- Thumbnails cho các ảnh phụ --}}
                                @foreach($collection->images as $image)
                                <div class="swiper-slide">
                                    <img src="{{ Storage::url($image->image) }}" class="h-24 w-full object-cover rounded-md border border-gray-200 cursor-pointer">
                                </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    {{-- Cột bên phải: Thông tin & Lựa chọn (Giữ nguyên) --}}
                    <div class="space-y-8">
                        <div>
                            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Váy Lụa Tay Phồng Cổ Vuông</h1>
                            <p class="text-3xl mt-3 tracking-tight text-gray-800">660.000đ</p>
                        </div>

                        <div class="prose prose-sm text-gray-600 leading-relaxed">
                            <p>Thiết kế thanh lịch và tinh tế, mẫu váy lụa tay phồng là lựa chọn hoàn hảo cho những buổi tiệc nhẹ hoặc dạo phố cuối tuần. Chất liệu lụa cao cấp mang lại cảm giác mềm mại, thoáng mát và tôn lên vẻ đẹp dịu dàng của người phụ nữ.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div id="color-selector" class="mt-4 flex items-center space-x-3">
                                ...
                                <button data-color="Be" class="h-8 w-8 rounded-full bg-amber-100 border-2 border-gray-200" aria-label="Be"></button>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div id="size-selector" class="mt-4 grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
                                ...
                                <button class="size-option group relative cursor-not-allowed flex items-center justify-center rounded-md border py-3 px-4 text-sm font-medium uppercase bg-gray-50 text-gray-200">XL</button>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-200 pt-8 space-y-6">
                            <div>
                                ...
                                <div class="accordion-content overflow-hidden max-h-0 transition-all duration-500 ease-in-out">
                                    <div class="prose prose-sm text-gray-600 pt-4">
                                        <ul>
                                            <li>Chất liệu: Lụa tơ tằm tổng hợp</li>
                                            <li>Kiểu dáng: Cổ vuông, tay phồng, dáng chữ A</li>
                            ...
                            <div>
                                ...
                                <div class="accordion-content overflow-hidden max-h-0 transition-all duration-500 ease-in-out">
                                    <div class="prose prose-sm text-gray-600 pt-4">
                                        <p>Miễn phí vận chuyển cho đơn hàng từ 1.000.000đ. Hỗ trợ đổi trả trong vòng 7 ngày nếu sản phẩm có lỗi từ nhà sản xuất.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // --- LOGIC MỚI CHO GALLERY ẢNH ---
        // 1. Khởi tạo slider ảnh thu nhỏ (thumbnail)
        ...
        // 2. Khởi tạo slider ảnh chính và liên kết với slider thumbnail
        ...
        // Gán sự kiện click cho tất cả ảnh trong slider chính
        ...
        // --- LOGIC GIAO DIỆN HIỆN ĐẠI (Giữ nguyên) ---
