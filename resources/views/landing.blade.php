...
@section('title', 'LadyFashion - Thời trang nữ cao cấp')
    ...
    <section class="py-20 md:py-32 bg-white">
        <div class="container mx-auto px-6">
            ...
            <div class="text-center max-w-2xl mx-auto mb-16">
                ...
                <p class="mt-4 text-lg text-slate-600 leading-relaxed">
                    Khám phá phong cách thời trang mới nhất từ LadyFashion
                </p>
            </div>
    ...
    <section class="py-20 md:py-32 bg-gradient-to-b from-white to-pink-50/30">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-2xl mx-auto mb-16">
                ...
                <p class="mt-4 text-lg text-slate-600 leading-relaxed">
                    Cảm ơn các nàng đã tin tưởng và đồng hành cùng LadyFashion
                </p>
            </div>
            <div class="instagram-grid grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <!-- Instagram Post 1 -->
                <a href="https://www.instagram.com/ladyfashion.vn/" target="_blank" class="relative overflow-hidden rounded-lg aspect-square group">
            ...
            <div class="text-center mt-10">
                <a href="https://www.instagram.com/ladyfashion.vn/" target="_blank" class="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-3 px-8 rounded-lg hover:shadow-lg transition-all">
                    <i class="fab fa-instagram text-xl"></i>
                    Theo dõi @ladyfashion.vn
                </a>
            </div>
        </div>
    </section>
    <section id="contact" class="py-20 md:py-32 bg-background">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-2xl mx-auto mb-16">
                ...
                <p class="mt-4 text-lg text-muted leading-relaxed">Chúng tôi luôn sẵn sàng lắng nghe và tư vấn. Hãy kết nối với LadyFashion ngay hôm nay.</p>
            </div>
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="space-y-6">
                    <p class="flex items-start text-lg"><i class="fas fa-map-marker-alt text-secondary w-6 pt-1"></i> <span class="ml-4 text-muted">96a ngõ 1194 đường Láng, Đống Đa, Hà Nội</span></p>
...
<section class="py-20 md:py-32 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center max-w-2xl mx-auto mb-16">
            ...
            <p class="mt-4 text-lg text-slate-600 leading-relaxed">
                Những câu hỏi khách hàng thường gặp khi mua sắm tại LadyFashion
            </p>
        </div>
        <div class="max-w-3xl mx-auto space-y-4">
            ...
            <div class="faq-item bg-white border border-slate-200 rounded-xl overflow-hidden">
                ...
                <div class="faq-answer px-6 pb-5 text-slate-600 leading-relaxed hidden">
                    LadyFashion hỗ trợ đổi trả trong vòng 7 ngày nếu sản phẩm bị lỗi từ nhà sản xuất. Sản phẩm đổi trả phải còn nguyên tem mác, chưa qua sử dụng. Chi phí vận chuyển đổi trả sẽ do shop chịu nếu lỗi từ shop.
                </div>
            </div>
            <!-- FAQ 3 -->
            <div class="faq-item bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div class="faq-item bg-white border border-slate-200 rounded-xl overflow-hidden">
                ...
                <div class="faq-answer px-6 pb-5 text-slate-600 leading-relaxed hidden">
                    100% sản phẩm của LadyFashion được làm từ vải cao cấp nhập khẩu: vải Kate, vải Lụa, vải Tuysi, vải Thô... Mỗi sản phẩm đều có mô tả chi tiết về chất liệu để bạn dễ dàng lựa chọn.
                </div>
            </div>
            <!-- FAQ 5 -->
            <div class="faq-item bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div class="faq-item bg-white border border-slate-200 rounded-xl overflow-hidden">
                ...
                <div class="faq-answer px-6 pb-5 text-slate-600 leading-relaxed hidden">
                    Có! Showroom của shop tại: 96a ngõ 1194 đường Láng, Đống Đa, Hà Nội. Bạn có thể ghé trực tiếp để xem và thử sản phẩm. Nên inbox trước để shop sắp xếp và tư vấn tốt nhất nhé!
                </div>
            </div>
        </div>
